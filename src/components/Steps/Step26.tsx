...
const Step26 = () => {
  ...
  const problem = watch('step26.contacted.problem')
  const contactedSASB = watch('step26.contacted.who.SASB')
  const contactedDrainageIssue =
    watch('step26.contactedDrainageIssue') === LL.choices.yesNo[0]()
    ...
    <div css={tw`grid grid-cols-1 gap-6`}>
      ...
      {contactedDrainageIssue && (
        <div>
          ...
          <FieldErrorMessage name="step26.contacted.who" errors={errors} />
        </div>
      )}
      ...
      {contactedDrainageIssue && !contactedSASB && (
        <div>
          ...
          <FieldErrorMessage
            name="step26.SASBNotContactedReasons"
            errors={errors}
          />
        </div>
      )}
