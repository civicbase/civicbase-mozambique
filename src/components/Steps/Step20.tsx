...
const Step20 = () => {
  ...
  const contactecSASB = getValues(`step20.contactedWho.SASB`)
  const contactedOther = watch('step20.contactedWho')
  const contactedBefore = watch('step20.contacted') === LL.choices.yesNo[0]()
    ...
    <div css={tw`grid grid-cols-1 gap-6`}>
      ...
      {contactedBefore && !contactecSASB && (
        <div>
          ...
          <FieldErrorMessage name="step20.whyDidntContacted" errors={errors} />
        </div>
      )}
      {contactedBefore && contactecSASB && (
        <div>
