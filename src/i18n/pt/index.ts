...
const pt: BaseTranslation = {
  ...
  questions: {
    ...
    611: `Se você comparar a frequência de ocorrência de alagamentos depois de chuva no seu quarteirão entre Abril e Setembro de 2021 com a dos últimos 6 meses, nota alguma mudança?`,
